...
function App() {
  ...
  return (
    <div className="min-h-screen relative bg-cover bg-center bg-[url('https://cdn.pixabay.com/photo/2017/02/14/08/15/desktop-2065280_1280.png')]">
      {/* overlay */}
      ...
      <div className="z-50 w-full h-screen flex items-center justify-center gap-16">
        ...
        {weather && !error && !loading && (
          <div className="mt-8 bg-neutral-50/10 backdrop-blur-lg p-6 rounded-lg flex items-center justify-center flex-col border border-neutral-200/20 shadow-md w-full max-w-sm">
            <h2 className="text-xl font-bold text-neutral-100">{weather.name}</h2>
            ...
            <div className="space-y-2 text-center">
              <p className="text-neutral-100 text-base font-normal">
                Humidity: <span className="text-2xl font-semibold ml-2">{weather.main.humidity}</span>  %
              </p>

              <p className="text-neutral-100 text-base font-normal">
                Wind Speed: <span className="text-2xl font-semibold ml-2">{weather.wind.speed}</span> m/s
              </p>

              <p className="text-neutral-100 text-base font-normal">
                Weather: <span className="text-2xl font-semibold ml-2">{weather.weather[0].description}</span>
              </p>
